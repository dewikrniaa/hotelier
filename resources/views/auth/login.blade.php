...
<head>
  ...
  <title>Login | Edotel SMKN 1 Pekanbaru</title>
      ...
      <div class="authentication-inner py-4">
        ...
        <div class="card p-2">
          ...
          <div class="card-body mt-2">
            <h4 class="mb-2">Welcome to Edotel</h4>
            <p class="mb-4">Please sign-in to your account</p>
            @section('content')

            <form class="row g-3 needs-validation" novalidate method="post" action="{{ route('login.perform') }}">

              <input type="hidden" name="_token" value="{{ csrf_token() }}" />

              @include('layouts.partials.messages')
              <div class="form-floating form-floating-outline mb-3">
                <input type="text" class="form-control" name="username" value="{{ old('username') }}" placeholder="Enter your email or username" required="required" autofocus />
                ...
                <div class="form-password-toggle">
                  <div class="input-group input-group-merge">
                    <div class="form-floating form-floating-outline">
                      <input type="password" class="form-control" name="password" value="{{ old('password') }}" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
