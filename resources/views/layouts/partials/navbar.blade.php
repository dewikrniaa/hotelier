<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-semibold ms-2">EDOTEL</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    <!-- Dashboards/Beranda -->
    <li class="menu-item">
      <a href="{{ route('layouts.dashboard') }}" class="menu-link menu-toogle">
    ...
    <!-- Informasi Kamar -->
    <li class="menu-item">
      <a href="{{ route('kamar.index') }}" class="menu-link menu-toogle">
        <i class="menu-icon tf-icons mdi mdi-home-variant"></i>
        <div data-i18n="Layouts">Informasi Kamar</div>
      </a>
    </li>

    <!-- Check In -->
    <li class="menu-item">
      <a href="{{ route('checkin.index') }}" class="menu-link menu-toogle">
    ...
    <!-- Laporan -->
    <li class="menu-item">
            <a href="{{ route('laporan.index') }}" class="menu-link menu-toogle">
